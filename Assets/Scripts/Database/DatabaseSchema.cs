// Auto-generated from Database/plenus_schema.sql — keep both in sync.
// Used to create the database from scratch on first run (e.g. on a fresh
// device where only the game build exists and no plenus.db is present).
